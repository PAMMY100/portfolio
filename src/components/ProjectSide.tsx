...
const ProjectSide = ({currentTab, setTab }: Props) => {
  return (
    <aside className='font-fira-code flex flex-col gap-4 md:w-[311px] border-r-2 border-l-2 border-[#90A1B9]'>
        <div className='gap-2 flex flex-col border-b-2 border-[#90A1B9]'>
                    {[
                      ...
                      <button
                        ...
                        className={`flex items-center gap-2 pl-1 h-[80px] text-sm border-b-2 border-[#90A1B9] hover:text-blue-400 ${currentTab === item.id ? 'font-bold text-blue-400' : ''}`}
                      >
